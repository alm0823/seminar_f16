...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in `[.data.frame`(gen, , c(mmiss25, 611)): undefined columns selected}}

{\ttfamily\noindent\bfseries\color{errorcolor}{Error in factor(dat25\_bz16\$value, levels = c("{}A"{}, "{}B"{}, "{}missing"{})): object 'dat25\_bz16' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{Error in dat25\_bz16[is.na(dat25\_bz16)] <- "{}missing"{}: object 'dat25\_bz16' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{Error in `[.data.frame`(gen, , c(mmiss30, 611)): undefined columns selected}}

{\ttfamily\noindent\bfseries\color{errorcolor}{Error in factor(dat30\_bz16\$value, levels = c("{}A"{}, "{}B"{}, "{}missing"{})): object 'dat30\_bz16' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{Error in dat30\_bz16[is.na(dat30\_bz16)] <- "{}missing"{}: object 'dat30\_bz16' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{Error in `[.data.frame`(gen, , c(mmiss35, 611)): undefined columns selected}}

{\ttfamily\noindent\bfseries\color{errorcolor}{Error in factor(dat35\_bz16\$value, levels = c("{}A"{}, "{}B"{}, "{}missing"{})): object 'dat35\_bz16' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{Error in dat35\_bz16[is.na(dat35\_bz16)] <- "{}missing"{}: object 'dat35\_bz16' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{Error in `[.data.frame`(gen, , c(mmiss40, 611)): undefined columns selected}}

{\ttfamily\noindent\bfseries\color{errorcolor}{Error in factor(dat40\_bz16\$value, levels = c("{}A"{}, "{}B"{}, "{}missing"{})): object 'dat40\_bz16' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{Error in dat40\_bz16[is.na(dat40\_bz16)] <- "{}missing"{}: object 'dat40\_bz16' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{Error in `[.data.frame`(gen, , c(mmiss45, 611)): undefined columns selected}}

{\ttfamily\noindent\bfseries\color{errorcolor}{Error in factor(dat45\_bz16\$value, levels = c("{}A"{}, "{}B"{}, "{}missing"{})): object 'dat45\_bz16' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{Error in dat45\_bz16[is.na(dat45\_bz16)] <- "{}missing"{}: object 'dat45\_bz16' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{Error in `[.data.frame`(gen, , c(mmiss50, 611)): undefined columns selected}}

{\ttfamily\noindent\bfseries\color{errorcolor}{Error in factor(dat50\_bz16\$value, levels = c("{}A"{}, "{}B"{}, "{}missing"{})): object 'dat50\_bz16' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{Error in dat50\_bz16[is.na(dat50\_bz16)] <- "{}missing"{}: object 'dat50\_bz16' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in print(pandoc.table(lm.lodging)): could not find function "{}pandoc.table"{}}}

{\ttfamily\noindent\bfseries\color{errorcolor}{Error in print(pandoc.table(confint.table)): could not find function "{}pandoc.table"{}}}\end{kframe}
\end{knitrout}
