...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in eval(expr, envir, enclos): could not find function "{}beanplot"{}}}\end{kframe}
\end{knitrout}
