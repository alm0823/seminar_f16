...
corrplot.mixed(correlation.1, tl.pos = 'lt', upper = "square", cex.axis = .9)
title("Bozeman All Years")
@
...
colnames(bozeman16)[colnames(bozeman16)=="avg_height_boze_2016"] <- "avg_plant_ht"
colnames(bozeman16)[colnames(bozeman16)=="avg_length_boze_2016"] <- "avg_plant_len"
...
corrplot.mixed (correlation.2, upper = "square", tl.pos = "lt")
##########################
...
par(mai =c(2,.5,.5,.5))
corrplot(correlation.3, type = "lower", method ="square" ,mar = c(4,0,0,0)) 
title("Bozeman 2014")
...
corrplot(correlation.4, mar = c(4,0,0,0), tl.pos = "lt", type = "lower", method = "upper")
@
