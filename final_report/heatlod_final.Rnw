...
<<siteyear, include = TRUE, eval = FALSE, warning = FALSE>>=
...
<<meanvars, include = TRUE, eval = FALSE, warning = FALSE>>=
...
<<regression, include = FALSE, eval = FALSE, warning = FALSE, message = FALSE>>=
